...
from views.auth.register import registerWindow
from views.home.home import homeWindow
from views.home.home_banned import homeBannedWindow
from widgets.auth_icons import manageVisibility
from widgets.auth_icons import on_enter as label_on_enter
from widgets.auth_icons import on_leave as label_on_leave
from widgets.auth_icons import togglePasswordVisibility
from widgets.button import on_enter as button_on_enter
from widgets.button import on_leave as button_on_leave
from widgets.input import on_click_outside, on_focus_in, on_focus_out
...
def loginWindow(event: object, Window: object):
    ...
    logo_image: Image.Image = Image.open("assets/images/Logo_auth.png")
    ...
    # email icon label
    emailIcon: Image.Image = Image.open("assets/images/UI_Icons/Email_Icon.png")
    ...
    # password icon label
    passwordIcon: Image.Image = Image.open("assets/images/UI_Icons/Password_Icon.png")
